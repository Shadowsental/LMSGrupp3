...
namespace LMSGrupp3.Controllers
{
    public class ActivitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,StartTime,EndTime,ActivityTypeId,ModuleId")] Activity activity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,StartTime,EndTime,ActivityTypeId,ModuleId")] Activity activity)
        {
            if (id != activity.Id)
            {
                return NotFound();
